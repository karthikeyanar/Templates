							...
							<table class="table table-striped">
								...
								<tbody>
									<tr>
										...
										<td>
											<code>btn btn-purple</code>
										</td>
										<td>
											Alternate dark purple button, not tied to a semantic action or use
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<code>btn btn-pink</code>
										</td>
										<td>
											Alternate dark pink button, not tied to a semantic action or use
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<code>btn btn-teal</code>
										</td>
										<td>
											Alternate dark teal button, not tied to a semantic action or use
										</td>
									</tr>
									<tr>
										<td>
											<button class="btn btn-cardovan" type="button">
												Cardovan</button>
										</td>
										<td>
											<code>btn btn-cardovan</code>
										</td>
										<td>
											Alternate dark cardovan button, not tied to a semantic action or use
										</td>
									</tr>
								</tbody>
							</table>
