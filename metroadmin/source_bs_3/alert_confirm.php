			...
			<div class="panel-body no-padding">
				<form action="#" method="POST" class="form-horizontal form-bordered form-striped">
					<div class="form-group">
						...
						<div class="col-lg-10">
							<a class='btn btn-success' data-placement='bottom' data-title='Confirm order and use selected payment method?' data-ok-class='btn-blue' data-cancel-class='btn-grey' data-ok-label='Confirm' data-cancel-label='Cancel' data-popover-confirm='alert("confirm")'  data-provide='bsconfirm'>Confirm and Purchase</a>
						</div>
					</div>
				</form>
			</div>
			...
			<div class="panel-body no-padding">
				<form action="#" method="POST" class="form-horizontal form-bordered form-striped">
					<div class="form-group">
						...
						<div class="col-lg-10">
							<a id="alert" class="btn btn-blue">View Demo</a>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<a id="prompt" class="btn btn-blue">View Demo</a>
						</div>
					</div>
				</form>
			</div>
