...
<title>Pepper - Form Validation</title>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="pull-left margin-right-10">
                            <select name="Month" id="Month" class="form-control" data-rule-required="true" data-msg-required="Required"
                        ...
                        <div class="pull-left margin-right-10">
                            <input type="text" name="day" id="day" class="form-control" style="width: 100px"
                                placeholder="Day" data-rule-required="true" data-msg-required="Required" data-placement="bottom" />
                        </div>
                        <div class="pull-left">
                            <input type="text" name="year" id="year" class="form-control" style="width: 100px"
                                placeholder="Year" data-rule-required="true" data-msg-required="Required" data-placement="bottom" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
