		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-white signup-panel">
				...
				<div class="panel-body">
					<form action="#" method="POST" id="registerForm" class="form-horizontal form-validate">
						...
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-font"></i>
									<input type="text" name="first_name" id="first_name" placeholder="First Name" data-rule-required="true" data-msg-required="Required"
										 class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-font"></i>
									<input type="text" name="last_name" id="last_name" placeholder="Last Name" data-rule-required="true" data-msg-required="Required"
										 class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-check"></i>
									<input type="text" name="address" id="address" placeholder="Address" data-rule-required="true" data-msg-required="Required"
										 class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-location-arrow"></i>
									<input type="text" name="city" id="city" placeholder="City" data-rule-required="true" data-msg-required="Required"
										 class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="select-group">
									<select id="country" name="country" data-placeholder="Choose a Country..." class="chosen-select"  data-rule-required="true" data-msg-required="Required">
										<option value=""></option>
						...
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-envelope"></i>
									<input type="text" name="email" id="email" placeholder="Email" data-rule-required="true" data-rule-email="true"
										data-msg-required="Required"  data-msg-email="Invalid Email"
										class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-lock"></i>
									<input type="password" name="password" id="password" placeholder="Password" class="form-control" data-rule-minlength="6"
										data-msg-required="Required" data-rule-required="true"  />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-icon"><i class="fa fa-check"></i>
									<input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" class="form-control"
										...
										data-msg-equalto="These passwords don't match. Try again?"  />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<label class="checkbox metro-checkbox primary">
									<input type="checkbox" name="policy" id="policy" class="form-control" data-msg-required="Required" data-rule-required="true" /><span class='text'>I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a></span>
								</label>
							</div>
						</div>
						<div class="form-group">
